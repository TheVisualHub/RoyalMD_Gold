...
# =============================================================================
#  STEP 0.7 (METAL EDITION): METAL SURFACE CONSTRUCTION
...
def solvate_system(protein_fixer, ff_protein, ff_water, ff_map, box_type,
    ...
    # --- METAL EDITION: metal XML joins the SAME ForceField, no second pipeline ---
...
def setup_and_run(modeller, forcefield, temperature, pressure, timestep, equil_time, production_time, report_interval, output_nc, log_freq, metal_resname=None, metal_cfg=None,
    ...
    # --- METAL EDITION: the metal gets its OWN force with its OWN global parameter.
...
def parse_args():
    ...
    # --- METAL EDITION: metal surface immobilization (opt-in, nothing else changes) ---
...
def main():
    ...
    # --- METAL EDITION config (None keeps v1.4 behaviour exactly) ---
    metal_cfg = None
    if args.metalsurf:
        metal_cfg = {
            'metal':           args.metal,
